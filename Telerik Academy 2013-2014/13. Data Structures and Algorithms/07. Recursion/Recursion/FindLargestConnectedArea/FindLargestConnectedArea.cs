...
*/
namespace FindLargestConnectedArea
{
    using System;
    ...
    public class FindLargestConnectedArea
    {
        ...
        private static ICollection<Position> maxPath = new HashSet<Position>();
        ...
        {
            Console.WriteLine("The largest connected area with {0} adjacent empty cells:", maxPath.Count);
