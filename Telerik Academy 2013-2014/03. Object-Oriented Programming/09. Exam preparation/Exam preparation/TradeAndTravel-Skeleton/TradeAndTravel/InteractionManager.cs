...
namespace TradeAndTravel
{
    public class InteractionManager
    {
        ...
        {
            if (actor.Location.LocationType.Equals(LocationType.Forest))
            {
                foreach (var item in actor.ListInventory())
                {
                    if (item is Weapon)
            ...
            else if (actor.Location.LocationType.Equals(LocationType.Mine))
            {
                foreach (var item in actor.ListInventory())
                {
                    if (item is Armor)
        ...
        {
            if (commandWords[2].Equals("armor"))
            {
                foreach (var item in actor.ListInventory())
                {
                    if (item is Iron)
            ...
            else if (commandWords[2].Equals("weapon"))
            {
