...
public class MainActivity extends Activity {
	private static final String downloadUrl = "http://www.9ori.com/store/media/images/8ab579a656.jpg";
	...
	private class ImageDownloader extends AsyncTask<String, Void, Bitmap> {
		...
		protected void onPreExecute() {
			...
			simpleWaitDialog = ProgressDialog.show(MainActivity.this, "Wait",
					"Downloading Image");
		}
