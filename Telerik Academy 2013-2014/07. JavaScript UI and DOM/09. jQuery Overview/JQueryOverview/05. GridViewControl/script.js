...
var controls = (function () {
    ...
    function listener(ev) {
        var clickedItem = ev.target,
            nextRow = $(clickedItem).parent().next(),
            contentCell = nextRow.children().first(),
            contentTable = contentCell.children().first();
