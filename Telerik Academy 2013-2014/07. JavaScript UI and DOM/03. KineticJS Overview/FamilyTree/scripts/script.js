window.onload = function () {
    ...
    familyMembers = [
        ...
        },
        {
            ...
            father: 'Boian Opanov',
            children: ['Maria Opanova',
                       'Patar Opanov']
        },
        {
            mother: 'Galina Hristova',
            father: 'Marin Hristov',
            children: ['Petar Hristov',
                       'Kamen Hristov',
                       'Ivan Hristov']
        },
        {
            ...
            for (el = 0; el < familyTree.length; el++) {
                if (familyTree[el].textArr) {
                    if (familyTree[el].textArr[0].text === nameOfChild) {
                        ...
                        layer.add(drawArrow(startXCoord + 70, startYCoord + 25, endXCoord, endYCoord));
                    }
                }
            }
        }
