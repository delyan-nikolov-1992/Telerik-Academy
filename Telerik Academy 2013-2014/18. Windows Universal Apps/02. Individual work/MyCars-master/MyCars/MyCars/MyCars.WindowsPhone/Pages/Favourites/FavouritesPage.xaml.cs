...
namespace MyCars.Pages.Favourites
{
    ...
    public sealed partial class FavouritesPage : Page
    {
        ...
        public FavouritesPage()
            : this(new FavouritesPageViewModel())
        {
        }
        ...
        public FavouritesPageViewModel ViewModel
        {
            get
            {
                return this.DataContext as FavouritesPageViewModel;
            }
        ...
        private async void OnCarsListItemHolding(object sender, HoldingRoutedEventArgs e)
        {
            ...
            var selectedObject = frameworkElement.DataContext as CarViewModel;
            ...
            await this.ViewModel.DeleteCar(selectedObject);
            this.Frame.Navigate(typeof(FavouritesPage), selectedObject);
        }
